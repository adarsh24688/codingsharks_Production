...
import { DATA_SCIENCE_COURSE_INDIA as data } from "@/data/seo-landing";
...
export default function DataScienceCourseIndiaPage() {
  const breadcrumb = breadcrumbSchema([
    { name: "Home", url: "/" },
    { name: "Data Science Course in India", url: `/${data.slug}` },
  ]);
