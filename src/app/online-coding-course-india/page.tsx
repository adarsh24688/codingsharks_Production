...
import { ONLINE_CODING_COURSE_INDIA as data } from "@/data/seo-landing";
...
export default function OnlineCodingCourseIndiaPage() {
  const breadcrumb = breadcrumbSchema([
    { name: "Home", url: "/" },
    { name: "Online Coding Course in India", url: `/${data.slug}` },
  ]);
  return (
    <>
