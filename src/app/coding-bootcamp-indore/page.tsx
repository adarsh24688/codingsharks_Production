...
import { CODING_BOOTCAMP_INDORE as data } from "@/data/seo-landing";
...
export default function CodingBootcampIndorePage() {
  const breadcrumb = breadcrumbSchema([
    { name: "Home", url: "/" },
    { name: "Coding Bootcamp in Indore", url: `/${data.slug}` },
  ]);
