...
import { BOOTCAMP_VS_SELF_TAUGHT as data } from "@/data/seo-landing";
...
export default function BootcampVsSelfTaughtPage() {
  const breadcrumb = breadcrumbSchema([
    { name: "Home", url: "/" },
    { name: "Coding Bootcamp vs Self-Taught", url: `/${data.slug}` },
  ]);
