...
import { CODING_COURSE_AFTER_12TH as data } from "@/data/seo-landing";
...
export default function CodingCourseAfter12thPage() {
  const breadcrumb = breadcrumbSchema([
    { name: "Home", url: "/" },
    { name: "Coding Course After 12th", url: `/${data.slug}` },
  ]);
  return (
    <>
